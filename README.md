...
| `22_strip_caret_m_from_names.sql` | Strips a literal `^M`/`^m` suffix left by a CSV import from 5,210 names across `creature_protos`, `quests_maps` and `boss_spawn` — visible on the nameplates of 2,441 spawned creatures, and breaking every name-based lookup |
