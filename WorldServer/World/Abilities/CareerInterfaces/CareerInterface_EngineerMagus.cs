...
namespace WorldServer.World.Abilities.CareerInterfaces
{
    internal class CareerInterface_EngineerMagus : CareerInterface, IPetCareerInterface
    {
        ...
        private float _rangeBonusPct1 = 0.0f;
        private readonly float _rangeBonusPct2Pet = 0.0f;
        private readonly float _rangeReductionPct3 = 0.0f;

        private readonly float _radiusBonusPctMaster = 50.0f / 8.0f;
