...
namespace WorldServer.World.Objects.Instances.SacellumDungeonsWestWingSacellum2
{
    ...
    {
        #region Constructors
        public SimpleSlorthThunderbelly(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
