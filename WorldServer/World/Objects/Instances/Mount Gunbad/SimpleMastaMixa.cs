...
namespace WorldServer.World.Objects.Instances.Mount_Gunbad
{
    ...
    {
        #region Constructors
        public SimpleMastaMixa(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
