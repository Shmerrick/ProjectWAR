...
namespace WorldServer.World.Objects.Instances.Mount_Gunbad
{
    ...
    {
        #region Constructors
        public SimpleArdtaFeed(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
