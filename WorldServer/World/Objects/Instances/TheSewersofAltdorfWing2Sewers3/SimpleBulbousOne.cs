...
namespace WorldServer.World.Objects.Instances.TheSewersofAltdorfWing2Sewers3
{
    ...
    {
        #region Constructors
        public SimpleBulbousOne(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
