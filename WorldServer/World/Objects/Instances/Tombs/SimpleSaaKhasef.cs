...
namespace WorldServer.World.Objects.Instances.Tombs
{
    ...
    {
        #region Constructors
        public SimpleSaaKhasef(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
