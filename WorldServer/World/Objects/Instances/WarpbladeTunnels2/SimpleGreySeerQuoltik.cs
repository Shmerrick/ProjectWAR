...
namespace WorldServer.World.Objects.Instances.WarpbladeTunnels2
{
    ...
    {
        #region Constructors
        public SimpleGreySeerQuoltik(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
