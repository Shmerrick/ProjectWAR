...
namespace WorldServer.World.Objects.Instances.Bilerot_Burrow
{
    public class SimpleBartholomeustheSickly : InstanceBossSpawn
    {
        ...
        public SimpleBartholomeustheSickly(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
        }
