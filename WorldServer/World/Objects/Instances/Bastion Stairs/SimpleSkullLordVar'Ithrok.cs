...
{
    public class Skull_Lord_Var_Ithrok : InstanceBossSpawn
    {
        #region Constructors

        public Skull_Lord_Var_Ithrok(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
        }
