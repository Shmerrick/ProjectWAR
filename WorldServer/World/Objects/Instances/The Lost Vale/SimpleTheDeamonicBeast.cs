...
namespace WorldServer.World.Objects.Instances
{
    public class SimpleTheDeamonicBeast : InstanceBossSpawn
    {
        ...
        public SimpleTheDeamonicBeast(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
