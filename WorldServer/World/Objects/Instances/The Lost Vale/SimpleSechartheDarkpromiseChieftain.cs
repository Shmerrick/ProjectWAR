...
namespace WorldServer.World.Objects.Instances.The_Lost_Vale
{
    ...
    {
        #region Constructors
        public SimpleSechartheDarkpromiseChieftain(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
