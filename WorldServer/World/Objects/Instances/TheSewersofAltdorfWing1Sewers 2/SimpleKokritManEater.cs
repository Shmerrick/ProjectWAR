...
namespace WorldServer.World.Objects.Instances.TheSewersofAltdorfWing1Sewers2
{
    ...
    {
        #region Constructors
        public SimpleKokritManEater(Creature_spawn spawn, uint instancegroupspawnid, uint bossid, ushort Instanceid, Instance instance) : base(spawn, instancegroupspawnid, bossid, Instanceid, instance)
        {
