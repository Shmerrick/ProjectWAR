...
namespace WorldServer.Managers.Commands
{
    ...
    public class CommandDeclarations
    {
        ...
        public static List<GmCommandHandler> WardCommands = CommandsBuilder.BuildCommands(typeof(WardCommands));
        ...
        public static List<GmCommandHandler> BaseCommand = new List<GmCommandHandler>
        {
            ...
            new GmCommandHandler("ward", null, WardCommands, EGmLevel.GM, 0, "Ward fragment task counter commands."),
            ...
            new GmCommandHandler("tokbestiary", AllTokBestiary, null, EGmLevel.Developer, 1, "Resend the player's real bestiary and ward action counters"),
            new GmCommandHandler("tometactic", TomeTacticInfo, null, EGmLevel.Developer, 0, "Reports which tome tactic effects apply to the current target"),
