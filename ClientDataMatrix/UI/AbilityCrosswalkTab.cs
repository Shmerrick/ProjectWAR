...
"",
"   DefaultLevelScalingFactor = 0.16667f is not invented. mythic_bin_abilityupgradeentry packs a",
"   32-bit float across V1 (low half) and V2 (high half), and 43713/15914 decodes to exactly",
"   0.166667. 0/16256 is 1.0; 0/16384 is 2.0.",
"",
"   But that value covers 25 of the table's 2,760 rows. The table also holds 1.0 (60 rows),",
"   0.8147, 0.7346, 0.6544, 0.5742, 0.5344, 0.4941, 0.2052 and more, in blocks of 12-16 rows.",
"   The client scales each ability by its own factor; the emulator falls back to one of them for",
"   everything it cannot resolve.",
"",
"   That is the most likely mechanism behind 'the tooltip says one number and the hit does",
"   another', and it would be invisible to this report: an ability can agree perfectly on",
"   MinDamage here and still hit for the wrong amount in play.",
"",
"   Caveat before anyone acts on it: the same V1/V2 pair also decodes to 5000, 3000, 1000, 2000",
"   and 6000 in other rows, which are not plausible scalars. The column means different things",
"   depending on Index, and that has not been decoded. Do not bulk-apply these as scalars.",
"",
"",
