...
namespace WorldServer.Test
{
	...
	public class LockoutTest
	{
		...
		public void MyLockoutTest()
		{
			...
			{
				InstanceID = "~260:20000",
				Bosseskilled = "3:4"
			};
			charValue.AddLockout(Lockout);
			Assert.AreEqual(charValue.Lockouts, "~260:20000:1:2:3:4:5");

			// Test 3:
			// Player Lockouts filled, add new Lockout of other zoneID
			Lockout = new Instance_Lockouts
			{
				InstanceID = "~197:30000",
				Bosseskilled = "6:9"
			};
			charValue.AddLockout(Lockout);
			Assert.AreEqual(charValue.Lockouts, "~260:20000:1:2:3:4:5~197:30000:6:9");
			Lockout = new Instance_Lockouts
			{
				InstanceID = "~100:40000",
				Bosseskilled = "331:789"
			};
			charValue.AddLockout(Lockout);
			Assert.AreEqual(charValue.Lockouts, "~260:20000:1:2:3:4:5~197:30000:6:9~100:40000:331:789");
			...
			foreach (string lo in allLockouts)
				allLo += lo;
			Assert.AreEqual(allLo, "~260:20000:1:2:3:4:5~197:30000:6:9~100:40000:331:789");

			// Test 5:
			// Player Lockout filled, remove a Lockout of containing zoneID
			charValue.RemoveLockout("~100:40000:331:789");
			Assert.AreEqual(charValue.Lockouts, "~260:20000:1:2:3:4:5~197:30000:6:9");
			...
			Assert.AreEqual(validLo, "~260:20000:1:2:3:4:5");
