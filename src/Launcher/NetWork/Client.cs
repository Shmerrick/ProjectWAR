...
//
//                 var Reader = new StreamReader("UserSettings.xml");
//                 var line = "";
//                 var TotalStream = "";
//                 while ((line = Reader.ReadLine()) != null)
//                 {
//                     Print(line);
//                     var Pos = line.IndexOf("Language id=");
//                     if (Pos > 0)
//                     {
//                         Pos = line.IndexOf("\"") + 1;
...
//                 Reader.Close();
//
//                 var Writer = new StreamWriter("UserSettings.xml", false);
...
//         private byte[] m_tcpSendBuffer = new byte[65000];
//
//         // Liste des packets a sender
//         private readonly Queue<byte[]> m_tcpQueue = new Queue<byte[]>(256);
//
...
//         }
//
//         private readonly AsyncCallback m_asyncTcpCallback = AsyncTcpSendCallback;
//
//         private void AsyncTcpSendCallback(IAsyncResult ar)
//         {
//             try
//             {
//                 var q = m_tcpQueue;
...
//         {
//             _logger.Debug($"Socket Connected {_tcpClient.Connected}");
//
...
//                 else
//                 {
//                     _tcpClient.BeginReceive(_pBuf, 0, bufSize, SocketFlags.None, ReceiveCallback, null);
//                 }
//             }
//         }
//
...
//
//             var Info = new FileInfo("mythloginserviceconfig.xml");
//             if (Info.Exists)
//             {
//                 Out.WriteByte(1);
...
//                 {
//                     var encryptAddress = (0x00957FBE + 3) - 0x00400000;
...
//                     var decryptAddress1 = (0x009580CB) - 0x00400000;
...
//                     var decryptAddress2 = (0x0095814B) - 0x00400000;
...
//         }
//
//         public void UpdateWarData(byte[] data)
//         {
//             try
//             {
//                 _logger.Info("Updating mythloginserviceconfig.xml");
//                 using (var fs = new FileStream(Application.StartupPath + "\\mythloginserviceconfig.xml", FileMode.CreateNew, FileAccess.Write))
//                 {
...
//         }
//
//         public void UpdateWarData()
//         {
//             try
//             {
//                 _logger.Info("Updating data.myp");
//                 var fileStream = File.Open("..\\data.myp", FileMode.Open, FileAccess.ReadWrite);
//                 var myp = new MYP(MythicPackage.ART, (Stream)fileStream);
//             
...
//                     return;
//                 }
//                 using (var reader = new FileStream(Application.StartupPath + "\\mythloginserviceconfig.xml", FileMode.Open))
//                 {
