...
namespace FrameWork
{
    ...
    {
        private static Random m_Random = new Random(Convert.ToInt32(DateTime.Now.ToString("ss")));
        ...
        public static List<T> ConvertStringToArray<T>(string Value)
        {
        ...
        public static string ConvertArrayToString<T>(T[] Value)
        {
            string Result = "";
        ...
        public static float[] StringToPosition(string Str)
        {
        ...
        public static string ChannelsToString(Dictionary<int, Color> Chans)
        {
            string Result = "";
        ...
        public static Dictionary<int, Color> StringToChannels(string Str)
        {
        ...
        public static string EquipementToString(Dictionary<int, int> Chans)
        {
            string Result = "";
        ...
        public static Dictionary<int, int> StringToEquipement(string Str)
        {
            // 1,134|2,18
        ...
        public static long Encode2Values(int P1, int P2)
        {
            return P1 << 32 + P2;
        }

        public static void Decode2Values(long Value, out int P1, out int P2)
        {
            P1 = (int)(Value >> 32);
            P2 = (int)(Value & 0xFFFFFFFF);
        }

        public static int Encode2Values(ushort P1, ushort P2)
        {
            return P1 << 16 + P2;
        }

        public static void Decode2Values(int Value, out ushort P1, out ushort P2)
        {
            P1 = (ushort)(Value >> 16);
            P2 = (ushort)(Value & 0xFFFF);
        }

        public static ushort Encode2Values(byte P1, byte P2)
        {
            return (ushort)((P1 << 8) + P2);
        }

        public static void Decode2Values(ushort Value, out byte P1, out byte P2)
        {
            P1 = (byte)(Value >> 8);
            P2 = (byte)(Value & 0xFF);
        }

        public static int Encode4Values(byte P1, byte P2, byte P3, byte P4)
        {
            return (P1 << 24) + (P2 << 16) + (P3 << 8) + P4;
        }

        public static void Decode4Values(int Value, out byte P1, out byte P2, out byte P3, out byte P4)
        {
            P1 = (byte)(Value >> 24);
            P2 = (byte)(Value >> 16);
            P3 = (byte)(Value >> 8);
