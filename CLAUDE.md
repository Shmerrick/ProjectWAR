...
- `docs/handoffs/` — dated session checkpoints. **`2026-09-05-commit-handoff.md` is current**; it records the Chaos Wastes entrance regression (BUG-062, diagnosed and fixed in its follow-up pass), PQ retest improvement, retracted blue-orb explanation and remaining work. The earlier checkpoint is historical; use the stabilization handoff for corrected influence-key evidence.
