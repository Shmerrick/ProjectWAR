...
{
    public class OpenInsertAbilityCommandMessage
    {
        #region properties
        ...
        public OpenInsertAbilityCommandMessage(string title, AbilityCommandModel model, ObservableCollection<string> targets, ObservableCollection<string> effectSources, ObservableCollection<string> cmdNames)
        {
            this.title = title;
            this.model = model;
