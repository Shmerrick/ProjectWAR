...
{
    public class OpenInsertAbilityMessage
    {
        #region properties
        ...
        public OpenInsertAbilityMessage(string title, AbilitySingleModel model, ObservableCollection<string> speclines, ObservableCollection<string> careerLines,
